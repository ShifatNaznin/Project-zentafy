    ...
    if($_SESSION['role']==1){
      ...
      get_sidebar();
       ...
       if(!empty($_POST)){
         ...
         $insert="INSERT INTO aboutus_det_title(aboutus_det_title,aboutus_det_subtitle_one,aboutus_det_subtitle_two) VALUES ('$title','$subtitle','$subtitletwo')";
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              ...
              <div class="col-md-3 text-right">
                <a href="all-aboutus-det-title.php" class="btn btn-sm btn btn-primary"><i class="fa fa-th"></i> All AboutUs Title/Subtitle</a>
              </div>
