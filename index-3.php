...
<!-- Mirrored from romantic-lalande-c64436.netlify.com/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2019 20:01:41 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title> zentafy - Responsive Bootstrap 4 Multipurpose Business Template</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text-center">
                                    ...
                                    <h1 class="home_title text-white mx-auto text-capitalize mb-0"> <span class="text-typed" data-elements="We Are Branding Design Studio ,We are Creative & Mordern Web Studio."></span> </h1>
                                    <div class="home_text_details">
                                        <p class="home_subtitle mt-4 mx-auto mb-0">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout readable English.</p>
                                    </div>

                                    <div class="home_btn_manage mt-5">
                                        <a href="#" class="btn btn_custom mr-3">Get Started</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            <h4 class="section-title pt-1">Welcome To Zentafy</h4>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="about_agency text-center mt-3">
                            ...
                            <p class="text-muted pt-2 text-center mx-auto">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>

                            <p class="text-muted pt-2 mx-auto">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text,</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row vertical_content_manage mt-5">
                    <div class="col-lg-6">
                        <div class="about_header_main mt-3">
                            <h4 class="about_heading font-weight-normal text-capitalize">A digital web studio creating stunning &amp;  online experiences.</h4>
                            <p class="text-muted pt-2"> voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem.</p>
                            <p class="text-muted pt-2">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>

                            <div class="mt-3">
                                <a href="#" class="btn btn_custom">Read more</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="video_section mt-3">
                            ...
                            <img src="images/video-img.png" alt="" class="img-fluid mx-auto d-block rounded">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            <h4 class="section-title pt-1">See what our Client's say</h4>
                            <p class="text-muted pt-2 section-subtitle mx-auto">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            <div class="section_subtitle_border mx-auto"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div id="owl-demo" class="owl-carousel">
                            <div class="text-center testi_box_all bg-light mt-3">
                                ...
                                <div class="">
                                    <p class="client_review text-muted font-italic text-center">" There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some."</p>
                                    <p class="client_name text-center text_custom mb-0 mt-3">Brian Walters</p>
                                    <p class="text-muted mb-0">Ceo/Founder</p>
                                    <div class="client_img mx-auto mt-3">
                                        <img src="images/client/client-1.jpg" alt="" class="img-fluid rounded-circle d-block">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center testi_box_all bg-light mt-3">
                                ...
                                <div class="">
                                    <p class="client_review text-muted font-italic text-center">"There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some."</p>
                                    <p class="client_name text-center text_custom mb-0 mt-3">Christopher Slater</p>
                                    <p class="text-muted mb-0">Director</p>
                                    <div class="client_img mx-auto mt-3">
                                        <img src="images/client/client-2.jpg" alt="" class="img-fluid rounded-circle d-block">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center testi_box_all bg-light mt-3">
                                ...
                                <div class="">
                                    <p class="client_review text-muted font-italic text-center">" There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some."</p>
                                    <p class="client_name text-center text_custom mb-0 mt-3">Brenda Cates</p>
                                    <p class="text-muted mb-0">Manager</p>
                                    <div class="client_img mx-auto mt-3">
                                        <img src="images/client/client-3.jpg" alt="" class="img-fluid rounded-circle d-block">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center testi_box_all bg-light mt-3">
                                ...
                                <div class="">
                                    <p class="client_review text-muted font-italic text-center">" There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some."</p>
                                    <p class="client_name text-center text_custom mb-0 mt-3">Amanda Mazza</p>
                                    <p class="text-muted mb-0">Sr. Developer</p>
                                    <div class="client_img mx-auto mt-3">
                                        <img src="images/client/client-4.jpg" alt="" class="img-fluid rounded-circle d-block">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="footer_logo_img mt-3">
                            <img src="images/logo-2.png" alt="" class="img-fluid d-block">
                        </div>
                        <div class="footer_about_detail mt-3">
                            <p class="mb-0 mt-3">1487 Yorkshire Circle.
                                <br> North Carolina, NY 27834.</p>
                            <p class="footer_alt_cpy mb-0 mt-3">2018 &copy; zentafy. Design by VBThemes.</p>
                    ...
                    <div class="col-lg-3">
                        <div class="footer_heading_tag mt-3">
                            <h6 class="font-weight-bold text-white">Solution</h6>
                        </div>
                        <div class="footer_links_all mt-3">
                            <ul class="list-unstyled mb-0">
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="footer_links_all mt-3">
                            <ul class="list-unstyled mb-0">
                                ...
                                <li><a href="#">Ideal Performance</a></li>
                                <li><a href="#">Reviews</a></li>
                                <li><a href="#">Innovative work</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from romantic-lalande-c64436.netlify.com/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2019 20:01:50 GMT -->
</html>